...
$sql = "SELECT movies_user_note.id_movie AS user_movie , movies_full.title AS full_title , movies_full.plot AS full_plot
...
foreach($selecteds as $selected){
  ...
  <div class="container container_films_thumb clearfix">
    <img class="film_thumb" src="posters/<?php echo $selected_id_movie ?>.jpg" alt="affiche de <?php echo $selected_title_movie ?>">
